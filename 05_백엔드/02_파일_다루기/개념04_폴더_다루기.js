...
const docsPdf = path.join(연습폴더, "docs", "pdf");
fs.mkdirSync(docsPdf, { recursive: true });
console.log("fs.existsSync(docsPdf)", fs.existsSync(docsPdf));
// fs.existsSync(docsPdf) true
...
// ✏️ 직접 해보기 3 — 깊은경로 폴더의 목록을 출력해 보세요. [ '3월보고서.pdf' ]
...
const 직접해보기6 = 저장폴더만들기(연습폴더, new Date(2026, 11, 25));
console.log("직접해보기6 : ", 직접해보기6);
// 직접해보기6 :  /Users/mjkim/Documents/GitHub/k-newdeal-posco-sf-ai/05_백엔드/02_파일_다루기/연습_업로드/2026/12
