...
const fileName = "회의록_2026.docx";

const ext_2 = path.extname(fileName);
const name_2 = path.basename(fileName, ext_2);

console.log("ext_2 : ", ext_2);
...
const name_3 = "검사성적서.xlsx";
const ext_3 = path.extname(name_3);
const base_3 = path.basename(name_3, ext);
const newName_3 = `${base_3}_백업${ext_3}`;
const savePath = path.join("uploads", newName_3);
console.log("savePath : ", savePath);
// savePath :  uploads/검사성적서.xlsx_백업.xlsx
...
console.log("✏️ 직접 해보기 5", path.join(__dirname, "data", "설정.json"));
